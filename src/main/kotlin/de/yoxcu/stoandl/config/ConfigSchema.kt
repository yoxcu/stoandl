...
val GUI_CONFIG_FIELDS: List<ConfigField> = listOf(
    ...
    combo("weather.location_source", "Weather location source",
        "Where the 'current location' weather comes from", listOf(
    ...
    combo("notification.default_mute", "Default mute for new apps",
        "How a newly-seen app is muted until you change it", listOf(
