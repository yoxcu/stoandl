...
**Near-term focus:** account-backed app store. (Firmware updates are done — see above, pending hardware verification.) Everything else below is parked or out of scope for now.
